...
if __name__=='__main__':
    ...
    parser.add_argument('-iters', help='boosting iters', dest='iters', default=30,type=int)  
    ...
    W,Z=train(boosting_iters=args.iters, X_uv=X_ci, X_uf=X_cj, linear_epoc=args.lepoc, batch_size=args.batch_size, eta=args.eta,
            a_1=args.alpha_1, a_3=args.alpha_3, lambda_epsilon=args.epsilon, context_num=8000)
